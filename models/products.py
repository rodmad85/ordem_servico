...
class ProdDimensions(models.Model):
    ...
    peso_esp = fields.Float(string='Peso Específico Kg/m³', store=True, default=7800, copy=True)
...
class OsProductinfo(models.Model):
    ...
    #
    #     self.ensure_one()
    #     # if 'product_length' not in default:
    #     default['product_length']= self.product_length
    #     # if 'product_height' not in default:
    #     default['product_height'] = self.product_height
    #     # if 'product_width' not in default:
    #     default['product_width'] = self.product_width
    #
    #     return super(OsProductinfo, self).copy(default)
